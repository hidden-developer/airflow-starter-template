...
from ..hooks.https import HttpsHook

if TYPE_CHECKING:
    from airflow.utils.context import Context


class HttpsSensor(BaseSensorOperator):
    """
    ...
    .. code-block:: python
        ...
        HttpsSensor(task_id="my_http_sensor", ..., response_check=response_check)

    .. seealso::
        For more information on how to use this operator, take a look at the guide:
        :ref:`howto/operator:HttpsSensor`
